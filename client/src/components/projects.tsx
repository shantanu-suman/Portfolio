import { ExternalLink, Github, Sprout, Hammer, Warehouse, TrendingUp, Heart } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="bg-secondary/50 rounded-xl overflow-hidden hover:scale-105 transition-all duration-300 group">
              {/* Project Icon */}
              ...
              <div className="p-6">
                ...
                <p className="text-slate-400 text-sm mb-4">{project.duration} | {project.type}</p>
